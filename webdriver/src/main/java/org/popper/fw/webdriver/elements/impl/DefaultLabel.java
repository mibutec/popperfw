 ...
 *
 */
public class DefaultLabel extends AbstractWebElement implements IWebLabel {
	
	public DefaultLabel(WebElementReference reference) {
		super(reference);
	}

	/*
	 * (non-Javadoc)
	 * @see org.popper.fw.element.ILabel#text()
	 */
	@Override
	public String text() {
