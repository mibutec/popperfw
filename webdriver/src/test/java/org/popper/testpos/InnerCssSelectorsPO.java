...
@Page(name="Login")
public interface InnerCssSelectorsPO {
	@PageAccessor(uri="/pages/TestHtml.html")
	void open();
	
	@Locator(name="Footer", cssSelector=".outerClass")
	Footer footer();

	public static interface Footer {
		@Locator(name="Inner", cssSelector=".innerClass")
		Inner inner();
		
		public static interface Inner {
			@Locator(name="The link", cssSelector="a")
			public ILink theLink();
		}
	}
}
