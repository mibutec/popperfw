...
@Page(name="Page with IFrame")
public interface PageWithIframePO {
	@PageAccessor(uri="/pages/pageWithIframe.html")
	void open();

	@Frame(id="iframe")
	DefaultAnnotationsPO iframeById();
	
	@Frame(cssSelector="#iframe")
	DefaultAnnotationsPO iframeByCss();
	
	@Frame(xpath="//*[@id='iframe']")
	DefaultAnnotationsPO iframeByXpath();
	
	@Frame(id="iframe")
	@Locator(name="some label", id="idLocator")
