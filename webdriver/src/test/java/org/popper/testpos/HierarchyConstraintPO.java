...
@Page(name="Login")
public interface HierarchyConstraintPO {
	@PageAccessor(uri="/pages/hierarchyConstraint.html")
	void open();
	
	@Locator(name="User by cssSelector", cssSelector=".testclass")
	User userByCss();
	
	@Locator(name="User by id", id="testid")
	User userById();
	
	public static interface User {
		@Locator(name="Forename", cssSelector=".forename")
		ILabel forename();
