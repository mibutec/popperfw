...
/**
 * Annotation to be annotated on annotations being processed by class forge. Tells classforge
 * in which order annotations should be processed, when there are several annotations
 * on one method.
 * 
 * In the following example SomeAnnotation2 will be always executed before SomeAnnotation1
 ...
 *
 * @ImplementedBy(...)
 * @RunBefore(SomeAnnotation1.class)
